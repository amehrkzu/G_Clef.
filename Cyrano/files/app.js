...
const ROLES = [
  { id: "MT", pair: "ST", kind: "tank", category: "tank", color: "#3b8ded", icon: "./files/TankRole.png" },
  { id: "ST", pair: "MT", kind: "tank", category: "tank", color: "#3b8ded", icon: "./files/TankRole.png" },
  { id: "H1", pair: "H2", kind: "healer", category: "healer", color: "#43a06b", icon: "./files/HealerRole.png" },
  { id: "H2", pair: "H1", kind: "healer", category: "healer", color: "#43a06b", icon: "./files/HealerRole.png" },
  { id: "D1", pair: "D2", kind: "dps", category: "melee", color: "#e34f57", icon: "./files/DPSRole.png" },
  { id: "D2", pair: "D1", kind: "dps", category: "melee", color: "#e34f57", icon: "./files/DPSRole.png" },
  { id: "D3", pair: "D4", kind: "dps", category: "ranged", color: "#e34f57", icon: "./files/DPSRole.png" },
  { id: "D4", pair: "D3", kind: "dps", category: "ranged", color: "#e34f57", icon: "./files/DPSRole.png" },
];
...
function drawMark(player) {
  ...
  ctx.lineWidth = 2;
  ctx.strokeStyle = yellowOmen ? "#fff4a8" : "#fff";
  if (player.mark === "share") {
    ctx.fillStyle = yellowOmen ? "#f0c94a" : "#e4ab2d";
    ctx.beginPath();
    ctx.roundRect(-8, -8, 16, 16, 3);
  } else if (player.mark === "circle") {
    ctx.fillStyle = yellowOmen ? "#f0c94a" : "#d84cac";
    ctx.beginPath();
    ctx.arc(0, 0, 8, 0, Math.PI * 2);
  } else {
    ctx.fillStyle = yellowOmen ? "#f0c94a" : "#7359ef";
    ctx.beginPath();
    ctx.moveTo(0, -9);
    ctx.lineTo(9, 8);
    ctx.lineTo(-9, 8);
